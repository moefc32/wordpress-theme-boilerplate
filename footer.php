<footer class="container-fluid upper-footer">
    <div class="container">
        <div class="col-sm-4 col-md-3 kotakan">
            <img alt="Students" src="<?php echo esc_url(get_template_directory_uri()) ?>/res/img/students.png">
            <hr>
            <address>
...
<footer class="container-fluid lower-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 credits">&copy; 2023 - <?php echo date("Y") ?>, <em>theme by</em> <a href="https://mf-chan.com">Mfc</a></div>
        </div>
    </div>
</footer>

<?php if (is_singular()) : ?>
    <script src="<?php echo esc_url(get_template_directory_uri()) ?>/res/js/jquery.min.js"></script>
    <script src="<?php echo esc_url(get_template_directory_uri()) ?>/res/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo esc_url(get_template_directory_uri()) ?>/res/js/script.js"></script>
<?php endif; ?>
<?php wp_footer(); ?>
</body>