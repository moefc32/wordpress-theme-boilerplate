        ...
        <div class="alert alert-danger">
            <div class="media">
                <div class="media-left">
                    <img src="<?php echo esc_url(get_template_directory_uri()) ?>/res/img/oops.png">
                </div>
                <div class="media-body">
                    ...
                    <form method="get" id="search_form" action="<?php echo get_home_url(); ?>" role="search">
                        <div class="input-group">
                            <input type="text" class="form-control" name="s" placeholder="Cari..." value="<?php printf(__('%s', wp_template), get_search_query()); ?>">
