...
<div class="container">
    <div class="col-sm-8">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>
                                ...
                                <ul class="pull-right">
                                    <?php $fields = array(
                                        'url' => array('icon' => 'home', 'label' => __('Website', wp_template)),
                                        'facebook' => array('icon' => 'facebook-square', 'label' => __('Facebook', wp_template)),
                                        'twitter' => array('icon' => 'twitter', 'label' => __('Twitter', wp_template)),
                                        'instagram' => array('icon' => 'instagram', 'label' => __('Instagram', wp_template)),
                                        'googleplus' => array('icon' => 'google-plus-square', 'label' => __('Google+', wp_template)),
                                        'github' => array('icon' => 'github', 'label' => __('Github', wp_template)),
                                    );
        ...
        <?php else : ?>
            <p><?php __('Halaman tidak tersedia.', wp_template); ?></p>
        <?php endif; ?>
    </div>
    <?php get_sidebar(); ?>
</div>
